...
return [
    ...
    'backup' => [
         ...
         */
        'database_dump_compressor' => \Spatie\Backup\Tasks\Backup\DbDumperFactory::GZIP_COMPRESSOR,
        ...
        'destination' => [
            ...
            'disks' => [
                'local',
                // Add S3 or other cloud storage here
                // 's3',
            ],
        ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
             ...
             * Monthly backups for the last 6 months
